...
//   let myStr = string.toLowerCase().match(/\p{L}/gu)
//   // .reverse().join('').toLowerCase()
  
//   // toLowerCase().split('').reverse().join('').replaceAll(' ','')
// return myStr

//   return myStr === string.toLowerCase().replaceAll(' ','')

// }console.log(pal('r........r.E eR.R'))
